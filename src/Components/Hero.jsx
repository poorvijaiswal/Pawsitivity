...
export default function Hero() {
  ...
  return (
    <section className="h-[calc(100vh-5rem)] overflow-hidden relative w-full bg-white rounded-lg mt-1" >
      ...
      <div className="container mx-auto px-6 py-8 flex flex-col lg:flex-row items-center justify-between h-full relative z-10 gap-8 xl:gap-12 2xl:gap-16 rounded-xl">
